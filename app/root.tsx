...
export function Layout({ children }: { children: React.ReactNode }) {
	return (
		<html lang="fr">
			...
			<body>
				<ParallaxDecor />
				<header className="site-header"><Link className="site-logo" to="/">Quentin <span>✦</span> Bérengère</Link><nav aria-label="Navigation principale"><Link to="/le-programme">Le programme</Link><Link to="/lieu">Le lieu</Link><Link to="/logement">Les logements</Link><Link to="/theme">Le thème</Link></nav></header>
				{children}
