...
export default function Home() {
    return <main className="home-page">
        ...
        <section className="intro-section"><p className="eyebrow">Tout ce qu&apos;il faut savoir</p><h2>Gardez le soleil<br/>dans
            vos agendas.</h2>
            <div className="page-links"><Link to="/lieu"><span>01</span><strong>Le lieu &amp; les
                logements</strong><b>→</b></Link><Link to="/theme"><span>02</span><strong>Le thème
                agrume</strong><b>→</b></Link><Link to="/journee"><span>03</span><strong>Le déroulé de la
