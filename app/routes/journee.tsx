...
export default function Journee() {
    return <main className="content-page day-page">
        ...
        <header className="page-hero"><p className="eyebrow">15 Août 2027</p><h2>Le retour<br/><em>une surprise gourmande.</em>
        </h2><p>un retour pour toujours plus de plaisir</p>
        </header>
