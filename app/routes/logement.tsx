        ...
        <section className="lodging-section"><p className="eyebrow">Nos bonnes adresses</p><h2>Où poser vos valises
            ...
            <div className="lodging-grid">
                <article><span>01</span><h3>La Grange de la Ménagerie</h3><p>Une première adresse à proximité immédiate
                    de l&apos;Étable de Beaupuy.</p><div className="lodging-facts"><p><span>Trajet</span>800m · env. 6 min à pieds</p><p><span>Budget</span>Dès 238 € / nuit</p></div><a href="https://maps.app.goo.gl/1txgGW6xfFesqT126" target="_blank"
                ...
                <article><span>02</span><h3>La Petite Ménagerie</h3><p>Une autre option tout près du lieu de
                    réception.</p><div className="lodging-facts"><p><span>Trajet</span>800m · env. 6 min  à pieds</p><p><span>Budget</span>Tarif sur demande</p></div><a href="https://maps.app.goo.gl/t33pXo4wBCFPWgTaA" target="_blank" rel="noreferrer">Voir
